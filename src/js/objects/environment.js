...
function createGround () {
  // Create Material
  let gMat = new BABYLON.StandardMaterial('groundmat', scene)

  // Create Texture
  let gTxt = new BABYLON.Texture(___S.TXT.Ground, scene)
  gTxt.vScale = 1.2
  gMat.diffuseTexture = gTxt

  // Create Mesh
  ground = BABYLON.MeshBuilder.CreateGround("ground", { width: 30, height: 50 }, scene)
...
function createFinishLines () {
  ...
  boxMaterial.diffuseTexture = new BABYLON.Texture("textures/wood.png", scene)
  boxMaterial.bumpTexture = new BABYLON.Texture("textures/wood-normal-map.png", scene)
  ...
  for (let i = 0; i < 5; i++) {
    ...
    box1.physicsImpostor = new BABYLON.PhysicsImpostor(
      box1, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, restitution: 0.9 }, scene)
...
function createBizbaszs () {
  ...
  times (10) (() => {
    ...
    obj1.physicsImpostor = new BABYLON.PhysicsImpostor(
      obj1, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, restitution: 0.5 }, scene)
  })
}
...
function createObtacles () {
  ...
  // Create material
  let boxTexture = new BABYLON.Texture("textures/wood.png", scene)
  //boxTexture.uScale = 5
  //boxTexture.vScale = 5
