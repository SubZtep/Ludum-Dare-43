...
export function getSphere (pos) {
  ...
  if (!_pool.empty()) {
    ...
    spMat.diffuseTexture = new BABYLON.Texture(___S.TXT.Sphere, scene)
    spMat.bumpTexture = new BABYLON.Texture(___S.TXT.SphereNormal, scene)
